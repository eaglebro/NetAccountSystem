...
<div id="main">
    ...
    <form action="<%=request.getContextPath()%>/cost/modi.do" method="get" class="main_form" accept-charset="UTF-8">
        <div class="text_info clearfix"><span>资费ID：</span></div>
        <div class="input_info"><input name="cost_id" type="text" class="readonly" readonly value="${cost.cost_id}"/>
        </div>
        ...
        <div class="input_info fee_type">
            <input type="radio" name="cost_type" id="monthly" checked=""
                   onclick="feeTypeChange(1);" value="1"/>
            <label for="monthly">包月</label>
            <input type="radio" name="cost_type" checked="" id="package"
                   onclick="feeTypeChange(2);" value="2"/>
            <label for="package">套餐</label>
            <input type="radio" name="cost_type" checked="" id="timeBased"
                   onclick="feeTypeChange(3);" value="3"/>
